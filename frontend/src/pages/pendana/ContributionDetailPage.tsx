      ...
      <Card>
        ...
        <CardContent className="pt-6 flex flex-col gap-6">
          ...
          <div>
            ...
            <div className="flex items-center justify-between p-4 bg-[var(--color-neutral-50)] rounded-[var(--radius-m)] border border-[var(--color-neutral-200)]">
              <div>
              ...
              <Link to={`/pendana/discover/${contribution.project.id}`}>
