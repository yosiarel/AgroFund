...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-b from-white/90 via-white/60 to-white/95 backdrop-blur-[2px]"></div>

        <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-40 flex flex-col items-center text-center z-10">

          <motion.h1
            initial="hidden"
            animate="visible"
            variants={fadeInUp}
            className="text-[var(--text-display-l)] sm:text-[var(--text-display-xl)] lg:text-7xl font-bold text-[var(--color-neutral-900)] tracking-tight mb-8"
          >
            Gotong Royong Digital <br className="hidden sm:block" />
            <span className="text-[var(--color-primary-600)]">Untuk UMKM Indonesia</span>
          </motion.h1>
          ...
          <motion.p
            ...
            animate="visible"
            variants={fadeInUp}
            className="text-[var(--text-body-l)] sm:text-xl text-[var(--color-neutral-700)] max-w-2xl mb-10 leading-relaxed font-[500]"
          >
